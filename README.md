...
[go2index/index.js](https://github.com/imSamirOFFICIAL/Google-Drive-Stream/blob/main/go2index/index.js) is the content of the Workers script.  
...
5. Download `index.js` in https://github.com/imSamirOFFICIAL/Google-Drive-Stream/tree/master/go2index and replace `client_id`,`client_secret`,`refresh_token` for what you just got.
